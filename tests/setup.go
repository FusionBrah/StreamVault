...
var (
    TestPostgresDatabase = "streamvault"
    TestPostgresUser     = "streamvault"
    TestPostgresPassword = "streamvault"
)
...
func SetupHTTP(t *testing.T) (*httpexpect.Expect, error) {
    ...
    // Get free port for StreamVault to run on
