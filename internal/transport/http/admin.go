...
//
//	@Summary		Get StreamVault video statistics
//	@Description	Get StreamVault video statistics
//	@Tags			admin
//	@Accept			json
//	@Produce		json
...
// GetInfo godoc
//
//	@Summary		Get StreamVault info
//	@Description	Get StreamVault info
//	@Tags			admin
//	@Accept			json
//	@Produce		json
...
func (h *Handler) GetInfo(c echo.Context) error {
	...
	if err != nil {
        return ErrorResponse(c, http.StatusInternalServerError, fmt.Sprintf("Error retrieving StreamVault information: %v", err))
	}
    return SuccessResponse(c, resp, "StreamVault information")
}
