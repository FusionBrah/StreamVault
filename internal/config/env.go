...
type EnvConfig struct {
	...
	// frontend
	CDN_URL string `env:"CDN_URL, default="` // Populate if using an external host for the static files (Nginx, S3, etc). By default StreamVault serves the VIDEOS_DIR directory.
}
