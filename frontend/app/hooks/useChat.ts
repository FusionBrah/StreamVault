...
export interface Comment {
  ...
  ganymede_formatted_badges: StreamVaultFormattedBadge[];
  ganymede_formatted_message: StreamVaultFormattedMessageFragment[];
}

export interface StreamVaultFormattedBadge {
  _id: string;
  version: string;
  title: string;
  url: string;
...
export interface StreamVaultFormattedMessageFragment {
  type: StreamVaultFormattedMessageType;
  text?: string;
  url?: string;
  emote?: StreamVaultFormattedEmote;
}

export enum StreamVaultFormattedMessageType {
  Text = "text",
  Emote = "emote",
}

export interface StreamVaultFormattedEmote {
  id: string;
  name: string;
  url: string;
  type: string;
