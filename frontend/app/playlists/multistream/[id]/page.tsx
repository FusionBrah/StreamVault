...
import StreamVaultLoader from "@/app/components/utils/StreamVaultLoader";
...
const PlaylistMultistream = ({ params }: { params: Promise<Params> }) => {
  ...
  if (isLoading) return <StreamVaultLoader />;
  ...
  return (
    <div>
      <Head>
        <title>{data.name} - StreamVault Multistream</title>
      </Head>
