"use client"
import StreamVaultLoadingText from "@/app/components/utils/StreamVaultLoadingText";
import { useGetStreamVaultStorageDistribution, useGetStreamVaultSystemOverview, useGetStreamVaultVideoStatistics } from "@/app/hooks/useAdmin";
...
const AdminOverviewPage = () => {
  ...
  const { data: videoStatistics, isPending: isPendingVideoStatistics, isError: isErrorVideoStatistics } = useGetStreamVaultVideoStatistics(axiosPrivate)
  const { data: systemOverview, isPending: isPendingSystemOverview, isError: isErrorSystemOverview } = useGetStreamVaultSystemOverview(axiosPrivate)
  const { data: storageDistribution, isPending: isPendingStorageDistribution, isError: isErrorStorageDistribution } = useGetStreamVaultStorageDistribution(axiosPrivate)
